...
ho.setVisible(true);        // TODO add your handling code here:
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
     ...
     String ps=jTextField3.getText();
        ...
        if (ps.equals("")) {
            JOptionPane.showMessageDialog(this,"Please enter address city name","Error",JOptionPane.ERROR_MESSAGE);
            return;
        }
               // TODO add your handling code here:
       DBC db=new DBC();
       String q="insert into users (Name,Email,Password) values ('"+name+"','"+em+"','"+ps+"')";
       db.executeNonSelect(q);
       try{
           if(db.rows>0)
           {
               JOptionPane.showMessageDialog(this,"You have Signed Up !!","Success",JOptionPane.INFORMATION_MESSAGE);
                this.setVisible(false);
        Login lg=new Login();
        lg.setVisible(true);
           }else
